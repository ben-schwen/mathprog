...
input_arg = 1
filepath = 'data/g0' + str(input_arg) + '.dat'
...
k = math.ceil((G.number_of_nodes()-1)/5) 
...
# o1 = ("MCF \t" + str(input_arg) +"\t"+ str(k1) +"\t"+ str(model1.objVal) 
#       +"\t"+ str(model1.getAttr("NodeCount")) +"\t"+  str(t1))
# o2 = ("MCF \t" + str(input_arg) +"\t"+ str(k2) +"\t"+ str(model2.objVal) 
